...
$string['clicktocyclestatuses'] = 'Click to cycle through statuses';
$string['clicktosetattendance'] = 'Click to set attendance';
...
$string['setallstatus'] = 'Set status for all users';
