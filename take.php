...
$pageparams->viewmode   = optional_param('viewmode', mod_attendance_take_page_params::SORTED_LIST, PARAM_INT);
$pageparams->gridcols   = optional_param('gridcols', null, PARAM_INT);
$pageparams->page       = optional_param('page', 1, PARAM_INT);
$pageparams->perpage    = optional_param('perpage', 0, PARAM_INT);
